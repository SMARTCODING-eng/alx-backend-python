...
SECRET_KEY = 'django-insecure-zr&3n7#j7qotn^zm8sh1n-+6*ch4v#^ph(fg_l-7fw=ws-@=hu'
...
# ... (other settings like INSTALLED_APPS, DATABASES, etc.) ...
...
SPECTACULAR_SETTINGS = {
    ...
    'DESCRIPTION': 'Documentation for the Messaging App Backend.',
    'VERSION': '1.0.0',
